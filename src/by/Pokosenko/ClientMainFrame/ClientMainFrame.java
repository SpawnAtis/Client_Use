package by.Pokosenko.ClientMainFrame;/*
 * To change this license header, choose License Headers in Project Properties.
 * To change this template file, choose Tools | Templates
 * and open the template in the editor.
 */

import by.Pokosenko.RegistrationFrame.RegistrationFrame;
import by.Pokosenko.SocketClient.SocketClient;
...
public class ClientMainFrame extends javax.swing.JFrame {
    ...
    private void RegistrationButtonMouseClicked(java.awt.event.MouseEvent evt) {
        ...
        try {
            regFrame = new RegistrationFrame(socketClient.socket);
        }
        catch (IOException e)
        {
            e.printStackTrace();
